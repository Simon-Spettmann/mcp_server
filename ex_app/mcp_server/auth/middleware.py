...
class DualAuthMiddleware(Middleware):
    ...
    def __init__(self, oauth_provider: NextcloudOAuthProvider, 
    ...
    async def on_message(self, context: MiddlewareContext, call_next):
        ...
        if user_info is None and "app_password" in self.enabled_methods and auth_header.startswith("Basic "):
        ...
        if user_info is None:
            raise Exception("Authentication required. Please provide a valid OAuth Bearer token, "
